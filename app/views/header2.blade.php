      ...
      <div class="carousel slide" id="jslide">
        <div id="jslide" class="carousel slide">
          <ol class="carousel-indicators">
            <li data-target="#jslide" data-slide-to="0" class="active">
            </li>
            <li data-target="#jslide" data-slide-to="1">
            </li>
            <li data-target="#jslide" data-slide-to="2">
            </li>
            <li data-target="#jslide" data-slide-to="3">
            </li>
          </ol>
